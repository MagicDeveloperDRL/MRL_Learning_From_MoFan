...
class Line_Trainer_Q_Learning(Trainer):
    def __init__(self,env,agent):
        super(Line_Trainer_Q_Learning,self).__init__(env,agent)
    ...
    def train(self,max_episodes,is_Learn = True):
        ...
        for episode in range(max_episodes):
            ...
            while True:
                ...
                # 学习本回合的经验(s, a, r, s)
                if is_Learn:
                    self.agent.learn(str(observation), action, reward, str(observation_))
                # 当前状态发生切换
...
class Maze_Trainer_Q_Learning(Trainer):
    def __init__(self,env,agent):
        super(Maze_Trainer_Q_Learning,self).__init__(env,agent)
...
class Maze_Trainer_Sarsa(Trainer):
    def __init__(self,env,agent):
        super(Maze_Trainer_Sarsa,self).__init__(env,agent)
